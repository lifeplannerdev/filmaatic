  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white py-20 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        {/* Page Title */}
        <h1 className="text-5xl font-bold text-center mb-8 animate-fade-in mt-10">
          About <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-500">Filmaatic</span>
        </h1>
        ...
        {/* Services Section */}
        <section className="mb-16 animate-fade-in-up mt-20">
          <h2 className="text-3xl font-semibold mb-6 text-center">What We Offer</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Acting School */}
            <div className="bg-slate-900/50 backdrop-blur-lg p-6 rounded-lg border border-slate-800 hover:border-pink-500 transition-all duration-300">
            ...
            {/* Dance Studio */}
            <div className="bg-slate-900/50 backdrop-blur-lg p-6 rounded-lg border border-slate-800 hover:border-purple-500 transition-all duration-300">
