  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white py-20 px-6 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        ...
        <div className="backdrop-blur-sm bg-white/5 rounded-2xl p-8 border border-white/10 shadow-xl animate-fade-in-delay-4">
          <div className="space-y-8">
            ...
            <div className="animate-fade-in-delay-6">
              <h2 className="text-2xl font-bold text-purple-400 mb-4">Why Choose Us?</h2>
            ...
            <div className="animate-fade-in-delay-7">
              <h2 className="text-2xl font-bold text-purple-400 mb-4">The Ultimate Showcase</h2>
            ...
            <div className="animate-fade-in-delay-8">
              <h2 className="text-2xl font-bold text-purple-400 mb-4">Exclusive Workshops</h2>
              <p className="mb-4 text-gray-200">
              ...
              <ul className="space-y-2 list-inside grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <li className="flex items-start gap-2 bg-white/5 p-3 rounded-lg md:col-span-2">
                  <span className="text-pink-400 flex-shrink-0 mt-1">•</span>
            ...
            {/* Journey to Stardom Section */}
            <div className="animate-fade-in-delay-9">
              <h2 className="text-2xl font-bold text-purple-400 mb-4">Your Journey to Stardom</h2>
        ...
        {/* Footer tagline */}
        <p className="text-2xl text-center font-bold mt-12 bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 bg-clip-text text-transparent animate-fade-in-delay-11">
